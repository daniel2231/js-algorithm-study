...
|------|------|-----------------|-----------------|--------|-----------|
| 1주 | 코테 준비 기초 | 입출력 연습 | 조건문/반복문 | ⭐ | 기본 문법 |
| 2주 | 플랫폼 & 분석법 | 시간복잡도 체감 | 효율성 테스트 | ⭐ | 시간복잡도 |
| 3주 | JS 필수 문법 | 배열/객체 조작 | 문자열 처리 | ⭐⭐ | JS 내장 함수 |
| 4주 | 배열 (Array) | 배열 기본 조작 | 2차원 배열 | ⭐⭐ | 인덱스 접근 |
| 5주 | 스택 (Stack) | 스택 구현 | 괄호 매칭 | ⭐⭐ | LIFO 구조 |
| 6주 | 큐 (Queue) | 큐 구현 | 프로세스 스케줄링 | ⭐⭐ | FIFO 구조 |
| 7주 | 해시 (Hash) | 해시맵 활용 | 중복 검사 | ⭐⭐⭐ | 해시 함수 |
| 8주 | 트리 (Tree) | 트리 순회 | 이진 탐색 트리 | ⭐⭐⭐ | 계층 구조 |
| 9주 | 집합 (Set) | 유니온-파인드 | 연결 성분 | ⭐⭐⭐ | 집합 연산 |
| 10주 | 그래프 (Graph) | DFS 구현 | BFS 구현 | ⭐⭐⭐ | 그래프 탐색 |
| 11주 | 그래프 심화 | 다익스트라 | 플로이드-워셜 | ⭐⭐⭐⭐ | 최단 경로 |
| 12주 | 백트래킹 | N-퀸 문제 | 순열/조합 | ⭐⭐⭐⭐ | 완전 탐색 |
| 13주 | 정렬 (Sorting) | 정렬 구현 | 정렬 활용 | ⭐⭐⭐ | 정렬 알고리즘 |
| 14주 | 시뮬레이션 | 구현 문제 | 좌표 계산 | ⭐⭐⭐ | 문제 이해력 |
| 15주 | 동적 계획법 (DP) | 기본 DP | LIS/LCS | ⭐⭐⭐⭐⭐ | 점화식 |
| 16주 | 그리디 & 정리 | 그리디 알고리즘 | 종합 문제 | ⭐⭐⭐⭐ | 탐욕적 선택 |
### **📈 진도 현황** (자동 업데이트)
...
**최종 업데이트:** 2025. 08. 14. 오전 03:31:43
<!-- PROGRESS_END -->
